...
@NgModule({
  declarations: [AppComponent, PageRegisterComponent, PageLoginComponent, PageFeedComponent, PageProfileComponent, PageMessagesComponent, PageSearchesComponent, PageFriendRequestsComponent, ResultRequestComponent, PostComponent, SidebarComponent, TopbarComponent, FormBgComponent],
